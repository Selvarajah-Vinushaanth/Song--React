...
export default function MetaphorClassifier() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-orange-400 to-amber-500 text-white p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-xl shadow-md p-6 mb-8">
              <h2 className="text-xl font-bold mb-4">Enter Tamil Text</h2>
              <textarea
                className="w-full border border-gray-300 rounded-lg p-3 h-40 font-tamil"
                value={inputText}
              ...
              <button
                className="bg-gradient-to-r from-orange-400 to-amber-500 text-white px-6 py-3 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center"
                  ...
                  {results.map((result, index) => (
                    <div 
                      ...
                      className={`border-l-4 ${
                        result.label === 'Metaphor' ? 'border-amber-500 bg-amber-50' : 'border-gray-400 bg-gray-50'
                      } p-4 rounded-lg`}
                    >
                      <p className="font-tamil text-lg mb-2">{result.text}</p>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <span className={`font-medium ${
                            result.label === 'Metaphor' ? 'text-amber-600' : 'text-gray-600'
                          }`}>
                            {result.label}
                          </span>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mb-8">
              ...
              <div className="space-y-3">
                {examples.map((example, index) => (
                  ...
                  >
                    <p className="font-tamil">{example.text}</p>
                    <div className="flex justify-between items-center mt-2 text-sm">
                      <span className={`font-medium ${
                        example.label.includes('Metaphor') ? 'text-amber-600' : 'text-gray-600'
                      }`}>
                        {example.label}
                      </span>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-amber-600">Metaphors:</span>
                      <span className="font-medium text-amber-600">{stats.metaphor_count}</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="font-medium">{stats.literal_count}</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div 
                  ...
                  <div className="pt-4">
                    <h3 className="font-medium text-gray-700 mb-2">Distribution</h3>
