...
export default function MetaphorCreator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-purple-400 to-pink-500 text-white p-6">
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 bg-white rounded-xl shadow-md p-6">
            <h2 className="text-xl font-bold mb-4">Create Metaphors</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full border border-gray-300 rounded-lg p-2 font-tamil"
              ...
              <button
                className="w-full bg-gradient-to-r from-purple-400 to-pink-500 text-white px-6 py-3 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center mt-4"
            ...
            {/* Examples */}
            <div className="mt-6">
              <h3 className="font-medium text-sm text-gray-700 mb-2">Examples</h3>
              <div className="space-y-2">
                {exampleSources.map((example, index) => (
                  <button
                    key={index}
                    className="block w-full text-left bg-gray-50 hover:bg-gray-100 p-2 rounded-lg text-sm transition-colors"
          ...
          <div className="md:col-span-2 bg-white rounded-xl shadow-md p-6">
            <h2 className="text-xl font-bold mb-4">Generated Metaphors</h2>
            ...
            {createdMetaphors.length > 0 ? (
              <div className="space-y-4">
                {createdMetaphors.map((metaphor, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg border border-purple-100 relative group"
                  >
                    <p className="text-lg font-tamil">{metaphor}</p>
                    
                    <button
                      className="absolute top-2 right-2 bg-white/70 hover:bg-white p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                      onClick={() => {
              ...
              <div className="bg-gray-50 p-6 rounded-lg border min-h-[300px] flex flex-col items-center justify-center text-gray-400">
            ...
            {createdMetaphors.length > 0 && (
              <div className="mt-4 flex justify-end">
                <button
                  className="bg-purple-100 hover:bg-purple-200 px-4 py-2 rounded-lg transition-colors text-purple-700 text-sm"
                  onClick={handleCreateMetaphors}
                >
            ...
            <div className="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
              <h3 className="font-medium text-gray-700 mb-2">About Metaphors</h3>
